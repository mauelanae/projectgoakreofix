...
<body>
    ...
    @endif
    <h1 class="mt-8 text-2xl font-bold text-center">FORMULIR SUSPEK AFP</h1>
    <form class="px-2 mb-8 max-w-3xl mx-auto space-y-6" action="{{route('storeafp')}}" method="POST">
        @csrf
        <div class="grid mt-8 gap-6 mb-14 md:grid-cols-2">
            ...
            <div>
                <label for="namasuspekafp" class="block mb-2 text-sm font-medium text-gray-900">NAMA SUSPEK
                    AFP</label>
                <input type="text" name="namasuspekafp"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
            </div>
            <div>
            ...
            <div>
                <label for="nohpkasus" class="block mb-2 text-sm font-medium text-gray-900">NO HP KASUS</label>
                <input type="text" name="nohpkasus"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                    placeholder="" required>
            </div>
            <div>
            ...
            <div>
                <label for="namaorangtua" class="block mb-2 text-sm font-medium text-gray-900">NAMA ORANG TUA</label>
            ...
            <div>
                <label for="tanggalmulaisakit" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL MULAI
                    SAKIT</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalmulaisakit"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="tanggalmulailumpuh" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL MULAI
                    LUMPUH</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalmulailumpuh"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="tanggalterimainformasi" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL
                    TERIMA INFORMASI</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalterimainformasi"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            ...
            <div>
                <label for="tanggalpolio" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL POLIO 4 TETES
                    TERAKHIR</label>
                <p class="text-sm font-light">Minimal diisi Bulan dan Tahun. Contoh : Januari 2024</p>
                <input type="text" name="tanggalpolio"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
            </div>
            <div>
                <label for="pengembilansempelpertama" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL
                    PENGAMBILAN SAMPEL 1</label>
                <div class="relative max-w-sm">
                    <input type="date" name="pengembilansempelpertama"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="pengembilansempelkedua" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL
                    PENGAMBILAN SAMPEL 2</label>
                <div class="relative max-w-sm">
                    <input type="date" name="pengembilansempelkedua"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
