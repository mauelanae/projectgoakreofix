...
<head>
    ...
    <title>Table Supek Difteri</title>
                ...
                <tbody
                    @foreach ($suspekdifteri as $item)
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4">{{ $item['statussempel'] }}</td>
                                <td class="px-6 py-4">{{ $item['jeniskelamin'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggallahir'] }}</td>
                                <td class="px-6 py-4">{{ $item['namasekolah_kerja'] }}</td>
                                ...
                                <td class="px-6 py-4">{{ $item['pengembilansempel'] }}</td>
                                <td class="px-6 py-4">{{ $item['pengirimansempeldkk'] }}</td>
                                <td class="px-6 py-4">
                                    <a href="{{route('createkonfirmasidifteri')}}" class="px-6 py-4 bg-utama rounded-xl font-bold text-white hover:bg-gray-300 hover:text-white">konfirmasi</a>
                                </td>
                            </tr> @endforeach
                    </tbody>
            </table>
