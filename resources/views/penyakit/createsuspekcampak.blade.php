...
<head>
    ...
    <title>Form Suspek Campak</title>
...
<body>
    ...
    @endif
    <h1 class="mt-8 text-2xl font-bold text-center">FORMULIR SUSPEK CAMPAK</h1>
    <form class="px-2 mb-8 max-w-3xl mx-auto space-y-6" action="{{route('storecampak')}}" method="POST">
        @csrf
        <div class="grid mt-8 gap-6 mb-14 md:grid-cols-2">
            ...
            <div>
                <label for="tanggalterimalaporan" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL TERIMA
                    LAPORAN</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalterimalaporan"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="tanggalpe" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL PE</label>
                <div class="relative max-w-sm">
            ...
            <div>
                <label for="namakasus" class="block mb-2 text-sm font-medium text-gray-900">NAMA KASUS</label>
            ...
            <div>
                <label for="naamaorangtua" class="block mb-2 text-sm font-medium text-gray-900">NAMA ORANG
                    TUA/WALI</label>
                <input type="text" name="namaorangtua"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
            </div>
            <div>
                <label for="tanggalmulaidemam" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL MULAI
                    DEMAM</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalmulaidemam"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="tanggalmulairash" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL MULAI
                    RASH</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalmulairash"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="riwayatvaksin" class="block mb-2 text-sm font-medium text-gray-900">RIWAYAT
                    VAKSINASI</label>
                <select name="riwayatvaksin"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
                    <option value="">Pilih Vaksinasi</option>
                    <option value="Imunisasi campak (MR) usia 9 bulan">Imunisasi campak (MR) usia 9 bulan</option>
                    <option value="Imunisasi campak (MR) usia 18 bulan">Imunisasi campak (MR) usia 18 bulan</option>
                    <option value="Imunisasi campak (MR) saat kelas 1 SD">Imunisasi campak (MR) saat kelas 1 SD
                    </option>
                </select>
            </div>
            <div>
                <label for="pernahimunisasiMMR" class="block mb-2 text-sm font-medium text-gray-900">PERNAH MENERIMA
                    IMUNISASI CAMPAK RUBELLA (MR) SAAT KAMPANYE IMUNISASI CAMPAK RUBELLA</label>
                <select name="pernahimunisasiMMR"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
            ...
            <div>
                <label for="tanggalvaksinMRterakhir" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL
                    VAKSINASI MR TERKAHIR</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalvaksinMRterakhir"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="pemberianvitA" class="block mb-2 text-sm font-medium text-gray-900">PEMBERIAN VITAMIN
                    A</label>
                <select name="pernahimunisasiMMR"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
            ...
            <div>
                <label for="apakahbepergian" class="block mb-2 text-sm font-medium text-gray-900">APAKAH BEPERGIAN 1
                    BULAN TERAKHIR?</label>
                <select name="apakahbepergian"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
                    <option value="">Pilih</option>
                    <option value="Iya">Iya</option>
            ...
            <div>
                <label for="apakahambildarah" class="block mb-2 text-sm font-medium text-gray-900">APAKAH SPESIMEN
                    DARAH DIAMBIL</label>
                <select name="apakahambildarah"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
                    <option value="">Pilih</option>
                    <option value="Iya">Iya</option>
            ...
            <div>
                <label for="tanggalambildarah" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL AMBIL
                    SPESIMEN DARAH</label>
                <p class="text-base text-utama -mt-1 mb-2">*Silahkan di isi jika memilih "Iya"</p>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalambildarah"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date">
                </div>
            </div>
            <div>
                <label for="apakahtesurin" class="block mb-2 text-sm font-medium text-gray-900">APAKAH SPESIMEN URIN
                    DIAMBIL</label>
                <select name="apakahtesurin"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
                    <option value="">Pilih</option>
                    <option value="Iya">Iya</option>
            ...
            <div>
                <label for="tanggalambilurin" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL AMBIL
                    SPESIMEN URIN</label>
                <p class="text-base text-utama -mt-1 mb-2">*Silahkan di isi jika memilih "Iya"</p>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalambilurin"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date">
                </div>
            </div>
            <div>
                <label for="tanggalpengirimankelab" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL
                    PENGIRIMAN SPESIMEN KE LAB</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalpengirimankelab"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                        placeholder="Select date" required>
                </div>
            </div>
            <div>
                <label for="keadaansaatini" class="block mb-2 text-sm font-medium text-gray-900">KEADAAN SAAT
                    INI</label>
                <select name="keadaansaatini"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
                    <option value="">Pilih</option>
