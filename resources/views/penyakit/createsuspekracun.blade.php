...
<head>
    ...
    <title>Form Keracunan Makanan</title>
...
<body>
    ...
    @endif
    <h1 class="mt-8 text-2xl font-bold text-center">FORMULIR KERACUNAN MAKANAN</h1>
    <form class="px-2 mb-8 max-w-3xl mx-auto space-y-6" action="{{route('storeracun')}}" method="POST">
        @csrf
        <div class="grid mt-8 gap-6 mb-80 md:grid-cols-2">
            <div>
            ...
            <div>
                <label for="namaindekkasus" class="block mb-2 text-sm font-medium text-gray-900">NAMA INDEK
                    KASUS</label>
                <input type="text" name="namaindekkasus"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
            </div>
            <div>
                <label for="lokasikejadian" class="block mb-2 text-sm font-medium text-gray-900">LOKASI
                    KEJADIAN</label>
            ...
            <div>
                <label for="tanggalinformasi" class="block mb-2 text-sm font-medium text-gray-900">TANGGAL TERIMA
                    INFORMASI</label>
                <div class="relative max-w-sm">
                    <input type="date" name="tanggalinformasi"
            ...
            <div>
                <label for="jenissempel" class="block mb-2 text-sm font-medium text-gray-900">JENIS SEMPEL</label>
                <input type="text" name="jenissempel"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="" required>
            </div>
        </div>
