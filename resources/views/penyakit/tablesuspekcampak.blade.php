...
<head>
    ...
    <title>Table Suspek Campak</title>
        ...
        <div class="flex overflow-auto p-4">
            <table class="text-sm text-black w-full">
                <thead class="text-xs text-black bg-gray-300">
                    ...
                    <th scope="col" class="px-2 py-4">NOMER EPID</th>
                ...
                <tbody
                    @foreach ($suscampak as $item)
                            <tr class="bg-white border-b">
                                <th class="px-6 py-4">{{ $item['id'] }}</th>
                                <td class="px-6 py-4">{{ $item['noepid'] }}</td>
                                <td class="px-6 py-4">{{ $item['puskesmas'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggalterimalaporan'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggalpe'] }}</td>
                                <td class="px-6 py-4">{{ $item['nik'] }}</td>
                                <td class="px-6 py-4">{{ $item['namakasus'] }}</td>
                                ...
                                <td class="px-6 py-4">{{ $item['tanggalmulaidemam'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggalmulairash'] }}</td>
                                <td class="px-6 py-4">{{ $item['riwayatvaksin'] }}</td>
                                <td class="px-6 py-4">{{ $item['pernahimunisasiMMR'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggalvaksinMRterakhir'] }}</td>
                                <td class="px-6 py-4">{{ $item['pemberianvitA'] }}</td>
                                <td class="px-6 py-4">{{ $item['apakahbepergian'] }}</td>
                                <td class="px-6 py-4">{{ $item['apakahambildarah'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggalambildarah'] }}</td>
                                <td class="px-6 py-4">{{ $item['apakahtesurin'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggalambilurin'] }}</td>
                                <td class="px-6 py-4">{{ $item['tanggalpengirimankelab'] }}</td>
                                <td class="px-6 py-4">{{ $item['keadaansaatini'] }}</td>
                                <td class="px-6 py-4">
                                    <a href="{{route('createkonfirmasicampak')}}" class="px-6 py-4 bg-utama rounded-xl font-bold text-white hover:bg-gray-300 hover:text-white">konfirmasi</a>
                                </td>
                            </tr> @endforeach
                    </tbody>
            </table>
