...
<head>
    ...
    <title>Form Konfirmasi Suspek Diftri</title>
...
<body>
    ...
    @endif
    <h1 class="mt-8 text-2xl font-bold text-center">FORMULIR KONFIRMASI DIFTERI</h1>
    <form class="px-2 mb-8 max-w-3xl mx-auto space-y-6" action="{{route('storekonfirmasidifteri')}}" method="POST">
        @csrf
        <div class="grid mt-8 gap-6 mb-14 md:grid-cols-2">
            ...
            <div>
                ...
                <select name="hasil"
                    ...
                    <option value="Positif">Negatif</option>
                </select>
            </div>
            <div>
