...
<head>
    ...
    <title>Form Konfirmasi Suspek Campak</title>
...
<body>
    ...
    @endif
    <h1 class="mt-8 text-2xl font-bold text-center">FORMULIR KONFIRMASI CAMPAK</h1>
    <form class="px-2 mb-8 max-w-3xl mx-auto space-y-6" action="{{route('storekonfirmasicampak')}}" method="POST">
        @csrf
        <div class="grid mt-8 gap-6 mb-14 md:grid-cols-2">
            ...
            <div>
                ...
                <select name="hasil"
                    ...
                    <option value="Positif Campak">Positif Campak</option>
                    <option value="Positif Rebula">Positif Rebula</option>
                    <option value="Positif Campak Rubela">Positif Campak Rubela</option>
