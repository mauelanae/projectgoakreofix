...
<head>
    ...
    <title>Form Konfirmasi Suspek AFP</title>
...
<body>
    ...
    @endif
    <h1 class="mt-8 text-2xl font-bold text-center">FORMULIR KONFIRMASI AFP</h1>
    <form class="px-2 mb-8 max-w-3xl mx-auto space-y-6" action="{{route('storekonfirmasiafp')}}" method="POST">
        @csrf
