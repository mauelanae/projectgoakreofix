...
return new class extends Migration
{
    ...
    {
        Schema::create('suspekracun', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('suspekracun');
    }
};
