...
return new class extends Migration
{
    ...
    {
        Schema::create('konfirmasiracun', function (Blueprint $table) {
            $table->integer('id');
            ...
            $table->date('sempelditerimadkk');
            $table->enum('status',['Proses Pemeriksaan','Keluar Hasil']);
            $table->text('hasilsempel')->nullable();
            $table->date('tanggalkeluarhasil')->nullable();
    ...
    {
        Schema::dropIfExists('konfirmasiracun');
    }
};
