...
return new class extends Migration
{
    ...
    {
        Schema::create('suspekafp', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('namasuspekafp');
            $table->string('nik');
            $table->string('nohpkasus');
            ...
            'TUGU']);
            $table->date('tanggalmulaisakit');
            $table->date('tanggalmulailumpuh');
            $table->date('tanggalterimainformasi');
            $table->date('tanggalpe');
            $table->string('populasirentan');
            $table->string('tanggalpolio');
            $table->date('pengembilansempelpertama');
            $table->date('pengembilansempelkedua');
