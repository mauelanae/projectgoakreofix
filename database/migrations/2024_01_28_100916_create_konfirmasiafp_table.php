...
return new class extends Migration
{
    ...
    {
        Schema::create('konfirmasiafp', function (Blueprint $table) {
            $table->integer('id');
            ...
            $table->enum('sempel1', ['Negatif', 'Positif'])->nullable();
            $table->enum('sempel2', ['Negatif', 'Positif'])->nullable();
            $table->enum('adikuat', ['Iya','Tidak'])->nullable();
    ...
    {
        Schema::dropIfExists('konfirmasiafp');
    }
};
